...
from frontend.config_util import config
from util.math_util import MathUtil
from util.network_util import ClientSocketProcessor, Message
...
class Gui(QWidget):
    ...
    def init_single_point_pos(self):
        ...
        with open('./frontend_config.yaml', 'r', encoding='utf-8') as f:
