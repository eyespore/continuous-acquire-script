    ...
    def xy_continuous_acquire(self, param_json: str):
        ...
        try:
            ...
            self.threads[ThreadID.ACQUIRE_THREAD_1] = (
                self.create_xy_acquire_closure(cam_id=cam_id, x_split=x_split, y_split=y_split, enable_extension=enable_extension,
...
class MenuUI(QWidget):
    ...
    def __init__(self):
        ...
        self.thread_closable = {
            'acquire_thread': False
        }
        ...
        # 构建弹窗门面
        self.dialog_facade = DialogFacade(self)
    ...
    def closeEvent(self, event):
        # self.dialog_facade.confirm('Are you sure you wanna quit?',
        #                            on_ok=self.on_ok, on_cancel=self.on_cancel)
        ...
