...
from util.config_util import ROOT_DIR
...
MENU_UI_PATH = f'{ROOT_DIR}/main_gui.ui'  # 菜单UI路径设定
...
class MainUI(QWidget):
    ...
    log_signal = pyqtSignal(str, bool, int)  # 控制台信号，提供线程在控制台打印输出的能力
    ...
    def init_signals(self):
        ...
        # 事件信号
        self.progress_signal.connect(self.set_progress_bar_val)  # 进度条信号，控制进图条渲染
        self.log_signal.connect(self.print_log)  # 日志信号，通过信号输出日志
        self.status_signal.connect(self.set_status)  # 恢复信号，恢复按钮正常使用
